...
import HomeMainNav from '../layout/HomeMainNav.js';
import IllustrationEmpty from '../../assets/suggestions/illustration-empty.svg';
import SuggestionCard from '../SuggestionCard.js';
import TabFilter from '../layout/TabFilter.js';
import RoadmapPanel from '../layout/RoadmapPanel.js';
        ...
        <div className='home-container'>
          <section className='home-left'>
            <div className='home-left-intro'>
              <div>
                <h2 className='home-left-intro-title'>Product Feedback Tool</h2>
